/**
 * Google Apps Script yang benar untuk Mahasiswa Feedback Platform
  ...
  try {
    ...
    if (action === "getPosts") {
      ...
      if (dataPostingan.length <= 1) {
        return ContentService().setText(JSON.stringify([])).setMimeType(ContentService.MimeType.JSON)
      }
      ...
      return ContentService().setText(JSON.stringify(postsPostingan)).setMimeType(ContentService.MimeType.JSON)
    }
